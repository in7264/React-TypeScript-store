...
export const ProductDetailsPage = () => {
  ...
  const [currentProduct, setCurrentProduct] = useState<ProductFull | null>(
    null,
  );
  const [currentProductShort, setCurrentProductShort] = useState<Product>();
  const [currentColor, setCurrenColor] = useState<string | undefined>(
    undefined,
  );
  const [currentCapacity, setCurrentCapacity] = useState<string | undefined>(
    undefined,
  );
  ...
  useEffect(() => {
    if (!currentProductsType.length || !products.length) {
      return;
    }
    ...
    <div className={styles.container}>
      ...
      <div className={styles.detailspage__shortIndormation}>
        ...
        <div className={styles.detailspage__prices}>
          <div className={styles.detailspage__price}>
            ${currentProduct?.priceDiscount}
          </div>
          <div className={styles.detailspage__fullPrice}>
        ...
        <div className={styles.detailspage__specs}>
          <div className={styles.detailspage__spec}>
            Screen{' '}
            <div className={styles.detailspage__char}>
      ...
      <div className={styles.container}>
        <div className={styles.detailspage__totalInformation}>
          ...
          {currentProduct?.description.map(item => {
            return (
              <div key={item.title}>
                <div className={styles.detailspage__totalTitle}>
                  {item.title}
                </div>
